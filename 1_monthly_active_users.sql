...
SELECT DATE_TRUNC('month', activity_timestamp) activity_month, count(distinct user_id) monthly_active_user_cnt
...
-- union all select 1, 'view_product', to_timestamp(current_date()-29), 'PRODUCT_D', '{ "price": "1500", "quantity": "2", "pageViews": "5"}'
...
-- union all select 3, 'view_product', to_timestamp(current_date()-29), 'PRODUCT_B', '{ "price": "1500", "quantity": "1", "pageViews": "11"}'
-- union all select 3, 'add_to_cart', current_timestamp(), 'PRODUCT_B', '{ "price": "1500", "quantity": "2", "pageViews": "10"}'
-- union all select 4, 'view_product', to_timestamp(current_date()-30), 'PRODUCT_C', '{ "price": "1500", "quantity": "1", "pageViews": "10"}'
-- union all select 4, 'add_to_cart', to_timestamp(current_date()-30), 'PRODUCT_C', '{ "price": "1500", "quantity": "2", "pageViews": "14"}'
-- union all select 5, 'view_product', to_timestamp(current_date()-30), 'PRODUCT_D', '{ "price": "1500", "quantity": "1", "pageViews": "14"}'
-- union all select 5, 'add_to_cart', to_timestamp(current_date()-30), 'PRODUCT_C', '{ "price": "1500", "quantity": "2", "pageViews": "14"}'
-- union all select 6, 'view_product', to_timestamp(current_date()-30), 'PRODUCT_B', '{ "price": "1500", "quantity": "1", "pageViews": "14"}'
-- union all select 6, 'add_to_cart', to_timestamp(current_date()-30), 'PRODUCT_B', '{ "price": "1500", "quantity": "2", "pageViews": "14"}'
-- union all select 7, 'view_product', to_timestamp(current_date()-60), 'PRODUCT_A', '{ "price": "1500", "quantity": "1", "pageViews": "17"}'
-- union all select 7, 'add_to_cart', current_timestamp(), 'PRODUCT_A', '{ "price": "1500", "quantity": "2", "pageViews": "17"}'
